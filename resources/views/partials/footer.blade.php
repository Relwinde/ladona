<!--==============================
	Footer Area
==============================-->
<footer class="footer-wrapper footer-layout2" data-bg-src="assets/img/bg/footer_bg_2_2.jpg">
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-6 col-xxl-3 col-xl-4">
                    <div class="widget footer-widget">
                        <div class="th-widget-about">
                            ...
                            <div class="th-widget-about">
                                <p class="footer-info"><i class="fa-sharp fa-solid fa-phone"></i><a class="text-inherit" href="#">+226 25 65 95 59</a></p>
                    ...
                    <div class="widget widget_nav_menu footer-widget">
                        ...
                        <div class="menu-all-pages-container">
                            <ul class="menu">
                                ...
                                <li><a href="service.html">Facials Waxing</a></li>
                                <li><a href="service.html">Body Waxing</a></li>
                                <li><a href="service.html">Brows & Lashes</a></li>
                                <li><a href="service.html">Body Massage</a></li>
                                <li><a href="service.html">Nail Art</a></li> --}}
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="widget footer-widget">
                        <h3 class="widget_title">Nos best sellers</h3>
    ...
    <div class="shape-mockup d-none d-xl-block" data-bottom="0%" data-right="0%"><img src="assets/img/shape/leaves_5.png" alt="shape"></div>
    <!-- Scroll To Top -->
